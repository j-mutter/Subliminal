...
- (void)setUpTestCaseWithSelector:(SEL)testCaseSelector
{
    ...
    SLAssertTrue([UIAElement(_aSwitch) isValidAndVisible],
                 @"Switch should be valid and visible");
    SLAssertTrue([UIAElement(_aSwitch) isTappable],
                 @"Switch should be tappable");
