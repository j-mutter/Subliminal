...
/**
 ...
 @param skipTests   If this is non-`NULL`, upon return, it will be set to `YES`, indicating that no tests are focused and
                    no tests from the test set should be run.
